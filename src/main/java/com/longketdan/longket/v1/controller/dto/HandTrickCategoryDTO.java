...
public class HandTrickCategoryDTO {
    @Data
    @Builder
    @ToString
    @NoArgsConstructor
    @AllArgsConstructor
    public static class handTrickCategoryResponse {
        ...
        public static HandTrickCategoryDTO.handTrickCategoryResponse of(HandTrickCategory footTrickCategory, int userTrickCount, int trickCount) {
            return handTrickCategoryResponse.builder()
